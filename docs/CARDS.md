...
`iphone-18-pro-burgundy.png` comes from the same kit as the 17 Pro and its window is the same pixels, so a storyboard swaps one for the other by the filename alone.
